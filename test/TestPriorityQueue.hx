...
class TestPriorityQueue extends AbstractTest
{
	...
	function testReserve()
	{
		...
		var d:ds.NativeArray<E> = flash.Vector.convert(l.mData);
		#else
		var d = l.mData;
		#end
	...
	function testRemove()
	{
		...
		pq = new ds.PriorityQueue<E>(false);
		var item = new E(1);
		pq.enqueue(item);
...
private class E extends ds.HashableItem implements ds.Prioritizable implements ds.Cloneable<E>
{
